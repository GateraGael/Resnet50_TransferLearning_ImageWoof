...
if __name__ == '__main__':
    ...
    test_img = tf.keras.utils.img_to_array(tf.keras.utils.load_img("Imagewoof_all/n02086240/n02086240_994.JPEG" , target_size=(224,224)))

    # Use The Function - Boom!
    VizGradCAM(tf.keras.applications.ResNet50(weights='imagenet'), test_img)